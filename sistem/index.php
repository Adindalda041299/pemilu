...
if(isset($_POST['simpan'])) {
  ...
  if ($cek > 0){
    echo"<script>window.alert('Maaf, Anda tidak bisa melakukan voting lagi')
          ...
          <div class="row">
            <div class="col-lg-12 ">
              <div class="alert alert-info">
                <strong><h2><b>Selamat datang</b></h2></strong><b style="font-size: 18px;"><?php echo $_SESSION['nama_mhs']; ?></b> Di HIMATIF GENERAL ELECTION WEBSITE
              </div>   
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-lg-12">
             <div class="alert alert-success">
              <div class="row">
                <div class="col-lg-12">
                  <h2 align="center"><b>KANDIDAT KETUA HIMATIF</b></h2><br>
                  <form action="" method="post">
                    ...
                    <?php } ?>
                    <input style="color: white; font-size: 20px; padding: 10px; border-radius: 15px; width: 100%;" type="submit" name="simpan" value="Vote" class="btn btn-success" onclick="return confirm('Apakah Anda Yakin Dengan Pilihan Anda?')">
                  </form>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-lg-12 ">
            <div class="alert alert-danger" style="text-align: center;">
              <strong>Ingat, Voting Hanya Bisa Dilakukan 1 Kali Saja </strong> 
            </div>
          </div>
        </div>
        <!-- /. ROW  --> 
