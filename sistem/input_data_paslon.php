                ...
                <table class="table table-striped table-bordered table-hover">
                  ...
                  while($d = mysqli_fetch_array($data_paslon)){
                    ...
                    <tr>
                      ...
                      <td><a class="btn btn-danger btn-circle" onclick="return confirm('Yakin hapus data ini !!!')" href="hapus.php?no_urut=<?php echo $d['no_urut']; ?>">Hapus</a></td>
                      <td><a class="btn btn-primary btn-circle" onclick="return confirm('Yakin Update data ini !!!')" href="update_data_paslon.php?no_urut=<?php echo $d['no_urut']; ?>">edit</a>
                      </td>
                    </tr>
                  <?php } ?>
                </table>
